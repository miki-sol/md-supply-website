...
export const site = {
  ...
  tagline: "Оптовые поставки и дистрибуция по СНГ",
  description:
    "MD Supply (ООО «МД Сапплай») — надёжный поставщик для розницы, опта, HoReCa и интернет-магазинов: оптовые поставки, дистрибуция и логистика по странам СНГ.",
